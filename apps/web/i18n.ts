...
async function loadMessages(locale: string) {
  ...
  const [
    ...
    import(`./messages/${locale}/passwordSetup.json`),
    import(`./messages/${locale}/passwordRecovery.json`),
  ...
  return {
    ...
    login: login.default,
    passwordSetup: passwordSetup.default,
    passwordRecovery: passwordRecovery.default,
