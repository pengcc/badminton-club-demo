...
import { LINEUP_POSITION_DEFINITIONS } from '@club/shared-types/domain/lineup';
...
export const LINEUP_POSITION_CONFIG: Record<
  LineupPosition,
  {
    ranking: number;
    maxPlayers: number;
...
> = {
  [LineupPosition.MEN_SINGLES_1]: {
    ranking: 1,
    maxPlayers:
      LINEUP_POSITION_DEFINITIONS[LineupPosition.MEN_SINGLES_1].capacity,
    allowedGenders: Gender.MALE,
    displayName: "Men's Singles 1",
  },
  [LineupPosition.MEN_SINGLES_2]: {
    ranking: 2,
    maxPlayers:
      LINEUP_POSITION_DEFINITIONS[LineupPosition.MEN_SINGLES_2].capacity,
    allowedGenders: Gender.MALE,
    displayName: "Men's Singles 2",
  },
  [LineupPosition.OPEN_SINGLES]: {
    ranking: 3,
    maxPlayers:
      LINEUP_POSITION_DEFINITIONS[LineupPosition.OPEN_SINGLES].capacity,
    allowedGenders: [Gender.MALE, Gender.FEMALE, Gender.NON_BINARY],
    displayName: 'Open Singles',
  },
  [LineupPosition.WOMEN_SINGLES]: {
    ranking: 4,
    maxPlayers:
      LINEUP_POSITION_DEFINITIONS[LineupPosition.WOMEN_SINGLES].capacity,
  ...
  [LineupPosition.MENS_DOUBLES]: {
    ranking: 5,
    maxPlayers:
      LINEUP_POSITION_DEFINITIONS[LineupPosition.MENS_DOUBLES].capacity,
    allowedGenders: Gender.MALE,
  ...
  [LineupPosition.OPEN_DOUBLES]: {
    ranking: 6,
    maxPlayers:
      LINEUP_POSITION_DEFINITIONS[LineupPosition.OPEN_DOUBLES].capacity,
    allowedGenders: [Gender.MALE, Gender.FEMALE, Gender.NON_BINARY],
  ...
  [LineupPosition.WOMEN_DOUBLES]: {
    ranking: 7,
    maxPlayers:
      LINEUP_POSITION_DEFINITIONS[LineupPosition.WOMEN_DOUBLES].capacity,
    allowedGenders: Gender.FEMALE,
  ...
  [LineupPosition.MIXED_DOUBLES]: {
    ranking: 8,
    maxPlayers:
      LINEUP_POSITION_DEFINITIONS[LineupPosition.MIXED_DOUBLES].capacity,
