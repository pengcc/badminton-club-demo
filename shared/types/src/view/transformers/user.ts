...
import type { Gender } from '../../core/enums';
...
export const UserViewTransformers = {
   ...
   */
  toUserProfile(
    user: Api.UserResponse & WithStringId & WithTimestamp
   ...
   */
  toUpdateRequest(
    formData: Partial<UserView.UserFormData>
  ): Api.UpdateUserRequest {
    const {
      gender,
      administratorDesignation: _designation,
...
function formatAddress(
  address: NonNullable<Api.UserResponse['address']>
): string {
